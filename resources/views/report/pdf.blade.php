...
<div class="page page-4">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <p class="text-center">Jouw unieke 2 KernKrachten geven jou de meeste energie. Naast
                slapen en relaxen natuurlijk. Als je in je KernKracht(en) staat en in beweging
                bent, krijg je eerder energie dan dat het je energie kost. Top toch!</p>
        </div>

        <div class="card">
            <div class="h6 text-center text-white">EEN BAAN</div>
            <p class="text-center">Wat voor een werkgever en collega’s passen bij jou? En welke
        ...
        <div class="card">
            ...
            <p class="text-center">We kunnen natuurlijk nooit een keuze voor jou maken. Wel kunnen
                we jou tools geven om jouw keuzes te versterken. Keuzes die je gelukkig en sterk
                maken. Die hulp en inzichten geven we a.d.h.v. jouw 2 KernKrachten.</p>
        </div>
        <br>
        <div class="card">
            <div class="h6 text-center text-white">MATCHING</div>
            <p class="text-center">Wie of wat past bij jou? Waar krijg je de meeste goede vibes
        ...
        <div class="card">
            ...
            <p class="text-center">Wij geloven in mooie eigenschappen en talenten. In matches
        ...
        <div class="card">
            ...
            <p class="text-center">Fijn als je jezelf in 2 woorden kan
                omschrijven {{ $client->first_name}}. Twee KernKrachten die je voorkeuren, talenten
                en handelen onthullen, dat wat jou mooi en aantrekkelijk maakt. Dit zelf-begrip
